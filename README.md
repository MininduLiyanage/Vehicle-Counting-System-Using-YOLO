...
## dependencies
The [sort module](https://github.com/abewley/sort) is used to track vehicles. It is a simple online and real-time tracking algorithm for 2D multiple object tracking in video sequences. It can be downloaded from this repository. 
